...
public class ContactsSectionIndexer implements SectionIndexer {
    ...
    public ContactsSectionIndexer(List<ClienteItemInterface> contacts) {
...
//		}
    ...
    public void initPositions(List<ClienteItemInterface> contacts)  {
        ...
        for(ClienteItemInterface contact: contacts){
